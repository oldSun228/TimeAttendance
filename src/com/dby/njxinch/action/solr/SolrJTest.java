...
public class SolrJTest {
    //指定solr服务器的地址
    private final static String SOLR_URL = "http://192.168.1.128:18001/solr/";
    ...
    public void querySolr() throws Exception{
        HttpSolrClient solrServer = new HttpSolrClient(SOLR_URL+"test_core/");
        ...
        if(tmpLists!=null && tmpLists.size()>0){
            ...
            for(User per:tmpLists){
                System.out.println("id:"+per.getAccount()+"description:"+per.getUserName());
            }
        }
    }
