...
window.MagicZoom = (function () {
   ...
   var s = function () {
      return "mgctlbxN$MZ" + "".toUpperCase() + " mgctlbxV$" + "v5.2.2".replace("v", "") + " mgctlbxL$" + "t".toUpperCase() + ((window.mgctlbx$Pltm && z.jTypeOf(window.mgctlbx$Pltm) === "string") ? " mgctlbxP$" + window.mgctlbx$Pltm.toLowerCase() : "")
   };
      ...
      move: function (L) {
         ...
         if (!this.moveTimer || Math.abs(K) > 0.000001 || Math.abs(J) > 0.000001) {
            ...
            this.zoomBox.image.jSetCss(z.browser.features.transform ? {
               transform: g + I + "px," + M + "px" + B + " scale(1)"
            } : {
