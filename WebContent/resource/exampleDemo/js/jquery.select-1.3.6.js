...
$.fn.extend({
	sSelect: function() {
		...
		$('#'+selectId+' ul').css("z-index","9999");
		$('#'+selectId+' h4').css("z-index","9999");
		...
		.bind("click",function(e){
			...
			if($('#'+selectId+' ul').css("display") == 'block'){
				...
				//if ($.browser.msie || $.browser.opera){$('.dropdown').css({'position':'relative','z-index':'19999'});}
				//$('#'+selectId).css({'position':'relative','z-index':'19999'});
				if ($.browser.msie || $.browser.opera){$('.dropdown').css({'position':'relative','z-index':'0'});}
				$('#'+selectId).css({'position':'relative','z-index':'9999'});
		 ...
		 .bind('mousewheel', function(e,delta) {
			  //parent.top.document.frames['center_gis'].scrolling='auto';
			  //parent.document.getElementById("center_gis").style.overflow="auto";
			 ...
			 // document.html.style.overFlow="auto";
			  //$(parent.document.getElementById("center_gis")).bind("onmousewheel",function (a){
				//  a.preventDefault();
				  //alert(a.preventDefault());
				  //a.returnValue = false; //禁止页面滚动
			  //});
			 //alert(parent.top.document.frames['center_gis'].scrolling);
			 //alert(document.documentElement.scrollTop);
			 // parent.top.document.frames['center_gis'].window.document.body.style.overFlow="no";
			 //alert(parent.top.document.frames['center_gis'].window.document.body.scrollHeight);
			 //parent.document.getElementById("center_gis").style.overFlow="yes";
			 //parent.document.getElementById("center_gis").scrolling="yes";
			 //alert(parent.document.getElementById("center_gis").style.overFlow);
			 //document.body.preventDefault();
			 //alert(parent.document.getElementById("center_gis").scrolling);
			 //prevent.prevent.prevent.document.body.style.overFlow="hidden";
