...
<head>
    ...
    <style type="text/css">
        ...
        #urlInfo {
            position: absolute;
            background: url(${pageContext.request.contextPath}/resource/images/r.gif) no-repeat 0 4px;
            visibility: hidden;
            z-index: 30000;
            padding-left: 12px;
            cursor: pointer;
    ...
    <script type="text/javascript">
        ...
        var m3D = function () {
            ...
            var diapo = [],
                    ...
                    selected,
                    urlInfo,
                    imagesPath = "${pageContext.request.contextPath}/resource/images/",
    ...
    setTimeout(function () {
        m3D.init(
                [
                    ...
                    {src: '200ff06c0e.jpg'},
                    {src: '5b0b0c8119.jpg'},
                    {src: '73d310387e.jpg', url: 'http://www.baidu.com', color: '#fff'}
                ]
        );
    }, 500);
</script>
